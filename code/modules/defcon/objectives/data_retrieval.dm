...
/datum/cm_objective/retrieve_data/New(faction_to_get)
	. = ..()
...
/datum/cm_objective/retrieve_data/terminal/New(faction_to_get, obj/structure/machinery/computer/objective/D)
	. = ..()
	terminal = D
...
/datum/cm_objective/retrieve_data/disk/New(faction_to_get, obj/item/disk/objective/O)
	. = ..()
	disk = O
...
/obj/structure/machinery/computer/objective/attack_hand(mob/living/user)
	...
	uploading = TRUE
	if(user.faction)
		objective.controller = user.faction.faction_name
	objective.activate()
...
/obj/structure/machinery/computer/disk_reader/attackby(obj/item/W, mob/living/user)
	if(istype(W, /obj/item/disk/objective))
		...
		user.count_statistic_stat(STATISTICS_DISK)

/obj/structure/machinery/computer/disk_reader/upp
